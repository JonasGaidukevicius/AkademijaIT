...
public class Main {
    public static void main(String[] args) {
        ...
        try{
            myCollection.addToCollection(new PostStamp("Lakunai", 10.5, 15.5));
            myCollection.addToCollection(new PostStamp("Pinigai", 90.5, 105.5));
            myCollection.addToCollection(new PostStamp("", 10.5, 15.5));
